...
new: 这个方法是在一个对象被实例化时首先被调用的。它负责对象的内存分配，并返回一个新的对象实例。默认情况下，__new__是一个静态方法，但可以通过在类中定义它来改变这一点。它经常被用于实现单例模式或者自定义对象的创建过程。

## 实验总结

总结一下这次实验你学习和使用到的知识，例如：编程工具的使用、数据结构、程序语言的语法、算法、编程技巧、编程思想。

本次实验学习了Python语言中如何继承父类和改写（override）父类的方法，以及如何定义类的属性和方法